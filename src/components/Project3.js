...
export const Project3 = () => {
	return (<section className='project-description-section'>
		...
		<p>This application combines the functionalities of a job tracker, map, time-sheets, and project database, providing a comprehensive solution for efficient project management. With its user-friendly interface and robust features, it streamlines workflow, enhances collaboration, and ensures accurate tracking of tasks and resources.</p>
		<p className='spacer' />
